...
public class EnemyHammerHit : MonoBehaviour
{
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.tag == "Player")
        {
            ...
            float damage = transform.parent.parent.GetComponent<EnemyController>().attack * (100 / (100 + collision.gameObject.GetComponent<PlayerController>().defense));
